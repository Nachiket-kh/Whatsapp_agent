...
export type Appointment = { id: string; patient_name: string; phone_number: string; doctor_name: string | null; department: string | null; appointment_date: string; appointment_time: string; status: "upcoming" | "completed" | "cancelled"; created_at: string };
